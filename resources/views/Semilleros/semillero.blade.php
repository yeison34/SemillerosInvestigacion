    ...
    <main>
        <div class="container-fluid px-4">
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item active">Semilleros</li>
            </ol>
                        ...
                        <tbody>
                            ...
                            @foreach($semillero as $items)  
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('/semillero/editarsemillero',$items->id)}}" class="btn btn-info">
                                        ...
                                        <a href="{{url('/semillero/eliminarsemillero',$items->id)}}" class="btn btn-danger">
